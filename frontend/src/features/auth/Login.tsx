...
export function Login() {
    ...
    const { register, handleSubmit, formState: { errors, ...formState } } = useForm<LoginFormValues>({
        ...
        <div className="flex min-h-screen items-center justify-center bg-background p-4">
            <div className="w-full max-w-sm">
                ...
                <p className="text-sm text-center text-muted-foreground mt-6">
                    ...
                    <span className="text-primary hover:underline cursor-pointer font-medium" onClick={() => navigate('/register')}>
                        Sign up
                    </span>
                </p>
            </div>
