...
export function Register() {
    ...
    const { register, handleSubmit, formState: { errors, ...formState } } = useForm<RegisterFormValues>({
        ...
        <div className="flex min-h-screen items-center justify-center bg-background p-4">
            <div className="w-full max-w-sm">
                ...
                <div className="flex items-center justify-center gap-2 mb-8">
                    ...
                    <span className="text-xl font-semibold tracking-tight">TaskMaster</span>
                </div>
                ...
                <div className="rounded-2xl border border-border/60 bg-card p-6 shadow-sm">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Input id="confirmPassword" type="password" className="h-10" {...register('confirmPassword')} />
                            {errors.confirmPassword && <p className="text-xs text-destructive mt-1">{errors.confirmPassword.message}</p>}
                        </div>

                        <Button className="w-full h-10 font-medium" type="submit" disabled={formState.isSubmitting}>
                ...
                <p className="text-sm text-center text-muted-foreground mt-6">
                    ...
                    <span className="text-primary hover:underline cursor-pointer font-medium" onClick={() => navigate('/login')}>
                        Sign in
                    </span>
                </p>
            </div>
